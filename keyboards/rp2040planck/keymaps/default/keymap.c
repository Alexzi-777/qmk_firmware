...
// └────┴────┴────┴────┴────┴────┴────┴────┴────┴────┘
    ...
    [_LOWER] = LAYOUT_ortho_4x10(
        ...
        KC_TAB,   LSFT(KC_TAB),   KC_MPRV, KC_MPLY, KC_MNXT, KC_NO,   KC_VOLD, KC_MUTE, KC_VOLU, KC_NO,
        KC_NO,   KC_NO,   KC_NO, _______,   KC_NO,  KC_ENT,   _______,   KC_NO, KC_NO,   KC_NO
    ),
...
// └────┴────┴────┴────┴────┴────┴────┴────┴────┴────┘
    ...
    [_ADJUST] = LAYOUT_ortho_4x10(
        ...
        _______,   _______,   _______,   _______,   KC_NO,   KC_NO,   _______,   _______, _______, _______
    ),
